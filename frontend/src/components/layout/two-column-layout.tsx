...
export function TwoColumnLayout({
  ...
  const toggle = collapsible ? (
    <button
      ...
      className="bg-card text-muted-foreground hover:text-foreground hidden h-8 w-6 shrink-0 items-center justify-center self-start rounded-md border shadow-sm transition-colors lg:flex"
    >
