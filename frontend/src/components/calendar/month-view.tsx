        ...
        {days.map((day) => {
          ...
          return (
            <button
              ...
              className={cn(
                'bg-background hover:bg-accent focus:ring-ring flex min-h-[7rem] flex-col items-stretch p-1.5 text-left focus:ring-1 focus:outline-none',
...
function groupEventsByDay(
  events: CalendarEventListItem[]
): Map<string, CalendarEventListItem[]> {
