        ...
        <KeyValueGrid
          items={[
            ...
            { label: 'Draft (ft)', value: data.draft_ft ?? '—' },
            {
              ...
              value: data.displacement_lbs ?? '—',
            },
            {
              label: 'Fuel Capacity (gal)',
              value: data.fuel_capacity_gal ?? '—',
            },
            { label: 'HIN', value: data.hin ?? '—' },
            {
              label: 'USCG Official #',
              value: data.uscg_official_number ?? '—',
            },
            {
              label: 'State Reg #',
              value: data.state_registration_number ?? '—',
            },
          ]}
        />
          ...
          renderItem={(engine) => (
            <ChildObjectRow
              ...
              subtitle={[
                ...
                .join(' · ')}
              actions={
                <ObjectActions data={engine} actionGroup="engine_actions" />
              }
            />
          )}
        />
