  ...
  validateSearch: (search: Record<string, unknown>): InboxSearch => {
    ...
    const view: InboxView | undefined =
      ...
      rawView === 'all'
        ? rawView
        : undefined;
    const mode: InboxMode | undefined =
      search.mode === 'calendar' ? 'calendar' : undefined;
    return {
      mode,
      view,
      thread: typeof search.thread === 'string' ? search.thread : undefined,
      calendarView: isCalendarView(search.calendarView)
        ? search.calendarView
        : undefined,
...
export const pricingGuideDetailRoute = createRoute({
  ...
  staticData: {
    crumb: (m) =>
      (m.loaderData as PricingGuideDetail | undefined)?.name ?? 'Pricing guide',
  },
